...
func NewTestAccountSettings() map[string]*gtsmodel.AccountSettings {
	return map[string]*gtsmodel.AccountSettings{
		...
		"admin_account": {
			...
			HideCollections:  util.Ptr(false),
			WebLayout:        gtsmodel.WebLayoutMicroblog,
			WebIncludeBoosts: util.Ptr(true),
		},
		"local_account_1": {
			AccountID:        "01F8MH1H7YV1Z7D2C8K2730QBF",
			CreatedAt:        TimeMustParse("2022-05-20T11:09:18Z"),
...
// NewTestStatuses returns a map of statuses keyed
// according to which account and status they are.
func NewTestStatuses() map[string]*gtsmodel.Status {
	return map[string]*gtsmodel.Status{
		...
		"admin_account_status_2": {
			...
			Flags:                    gtsmodel.StatusFlags(gtsmodel.StatusFlagLocal | gtsmodel.StatusFlagFederated | gtsmodel.StatusFlagSensitive),
			Content:                  "<p>🐕🐕🐕🐕🐕</p>",
			Text:                     "🐕🐕🐕🐕🐕",
			ContentType:              gtsmodel.StatusContentTypePlain,
		...
		"admin_account_status_5": {
			...
			Flags:                    gtsmodel.StatusFlags(gtsmodel.StatusFlagLocal | gtsmodel.StatusFlagFederated | gtsmodel.StatusFlagPendingApproval),
		...
		"local_account_1_status_1": {
			...
			Flags:                    gtsmodel.StatusFlags(gtsmodel.StatusFlagLocal | gtsmodel.StatusFlagSensitive | gtsmodel.StatusFlagFederated),
		...
		"local_account_2_status_4": {
			...
			Flags:                    gtsmodel.StatusFlags(gtsmodel.StatusFlagLocal | gtsmodel.StatusFlagSensitive),
		...
		"remote_account_2_status_1": {
			...
			Flags:               gtsmodel.StatusFlags(gtsmodel.StatusFlagSensitive | gtsmodel.StatusFlagFederated),
...
// NewTestStatusPins returns a map of status pins keyed
// by the test statuses key to which the pin corresponds to.
func NewTestStatusPins() map[string]*gtsmodel.StatusPin {
	return map[string]*gtsmodel.StatusPin{
		...
		"local_account_3_status_1": {
			StatusID:  "01JPCNB4417JG3XHHP0WS60RM3",
			AccountID: "01JPCMD83Y4WR901094YES3QC5",
			CreatedAt: TimeMustParse("2025-03-15T11:27:00Z"),
		},
	}
}
...
func NewTestInteractionRequests() map[string]*gtsmodel.InteractionRequest {
	return map[string]*gtsmodel.InteractionRequest{
		"admin_account_reply_turtle": {
			...
			InteractionRequestURI: "http://localhost:8080/users/admin/reply_requests/01J5QVXCCEATJYSXM9H6MZT4JR",
