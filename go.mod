...
replace modernc.org/sqlite => gitlab.com/NyaaaWhatsUpDoc/sqlite v1.54.0-concurrency-workaround
...
require (
	...
	codeberg.org/gruf/go-mempool v0.0.0-20260802001936-ec3fb73e5f30
