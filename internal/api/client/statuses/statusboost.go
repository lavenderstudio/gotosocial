...
func (m *Module) StatusBoostPOSTHandler(c *httputil.Context) {
	...
	apiStatus, errWithCode := m.processor.Status().BoostCreate(c, authed.Account, authed.Application, targetStatusID)
	if errWithCode != nil {
		apiutil.ErrorHandler(c, m.templates, errWithCode)
		return
	}
