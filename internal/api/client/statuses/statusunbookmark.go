...
func (m *Module) StatusUnbookmarkPOSTHandler(c *httputil.Context) {
	authed, errWithCode := apiutil.TokenAuth(c, apiutil.AuthRequirements{
		Token:   true,
		App:     true,
		User:    true,
		Account: true,
		Scope:   []apiutil.Scope{apiutil.ScopeWriteBookmarks},
	})
	if errWithCode != nil {
	...
	apiStatus, errWithCode := m.processor.Status().BookmarkRemove(c, authed.Account, targetStatusID)
	if errWithCode != nil {
		apiutil.ErrorHandler(c, m.templates, errWithCode)
		return
	}
