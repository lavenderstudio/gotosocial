...
func (m *Module) AccountNotePOSTHandler(c *httputil.Context) {
	...
	relationship, errWithCode := m.processor.Account().PutNote(c, authed.Account, targetAcctID, form.Comment)
	if errWithCode != nil {
		apiutil.ErrorHandler(c, m.templates, errWithCode)
		return
	}
