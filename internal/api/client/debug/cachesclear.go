...
// ClearCachesPOSTHandler swagger:operation POST /api/v1/debug/caches/clear clearCaches
//
...
func (m *Module) ClearCachesPOSTHandler(c *httputil.Context) {
